...
import { useFarmsList } from '@/hooks/use-farms';
...
import type { PaginatedResult, FarmItem } from '@/lib/types';

interface Props {
  userId: string;
  initialFarms: PaginatedResult<FarmItem>;
}

export function DashboardView({ userId, initialFarms }: Props) {
  const { data: farms = initialFarms } = useFarmsList(userId, 1, initialFarms);
        ...
        <div className="relative z-10 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted max-w-xl leading-relaxed">
              El microservicio de análisis y predicción de crecimiento procesará los
              datos registrados aquí para generar proyecciones de peso, mortalidad y
              fechas estimadas de cosecha.
            </p>
