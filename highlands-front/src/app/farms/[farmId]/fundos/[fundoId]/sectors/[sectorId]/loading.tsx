export default function SectorLoading() {
  return (
    <div className="animate-pulse space-y-6">
      <div className="h-4 w-80 rounded bg-surface-overlay" />
      <div className="flex items-center justify-between">
        <div>
          <div className="h-7 w-40 rounded-lg bg-surface-overlay" />
          <div className="mt-2 h-4 w-48 rounded-md bg-surface-overlay" />
        </div>
        <div className="h-10 w-40 rounded-lg bg-surface-overlay" />
      </div>
